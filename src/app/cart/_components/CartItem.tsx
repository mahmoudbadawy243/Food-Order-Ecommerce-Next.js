...
import { deliveryFee, getSubTotal } from "@/lib/cartQuantity"
import { deleteItemFromCart, removeItemFromCart, selectItemsOfCart } from "@/redux/features/cart/cartSlice"
                ...
                <div className='flex flex-col md:flex-row gap-6 justify-between'>
                  <div className='flex items-center gap-2'>
                    <div className='relative w-24 h-24'>
                      <Image src={item.image} className='object-contain' alt={item.name} fill />
                    </div>
                    <div>
